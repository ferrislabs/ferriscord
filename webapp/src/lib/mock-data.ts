...
export const mockUsers: User[] = [
  {
    ...
    avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612e637?w=100&h=100&fit=crop&crop=face',
    status: 'online',
...
export const mockServers: Server[] = [
  {
    id: 'server-1',
    name: 'Rust Community',
    description: 'A place for Rust developers to collaborate and share knowledge',
    icon: '🦀',
    ownerId: 'user-1',
    memberCount: 1247,
...
export const mockMessages: Message[] = [
  {
    ...
    reactions: [
      { emoji: '👋', count: 5, users: ['user-2', 'user-3', 'user-4', 'user-5', 'bot-1'] },
      { emoji: '🦀', count: 8, users: ['user-1', 'user-2', 'user-3', 'user-4', 'user-5', 'bot-1'] },
    ],
  },
  {
    id: 'msg-2',
    content: 'Thanks for creating this space! I\'m excited to learn more about Rust.',
    author: mockUsers[1],
    channelId: 'channel-1',
  ...
  {
    id: 'msg-3',
    content: 'I just published a new crate for async file handling. Check it out: https://crates.io/my-crate',
    author: mockUsers[2],
    channelId: 'channel-1',
  ...
  {
    id: 'msg-4',
    content: 'Can someone help me with borrowing rules? I\'m getting a lifetime error.',
    author: mockUsers[3],
    channelId: 'channel-2',
  ...
  {
    id: 'msg-6',
    content: 'Here\'s the problematic code:\n\n```rust\nfn main() {\n    let mut vec = vec![1, 2, 3];\n    let first = &vec[0];\n    vec.push(4);\n    println!("{}", first);\n}\n```',
    author: mockUsers[3],
    channelId: 'channel-2',
  ...
  {
    id: 'msg-7',
    content: 'The issue is that you\'re trying to mutate `vec` while holding an immutable reference to its content. The borrow checker prevents this because reallocating the vector could invalidate the reference.',
    author: mockUsers[1],
    channelId: 'channel-2',
  ...
  {
    id: 'msg-8',
    content: 'Thanks! That makes sense now. I need to either clone the value or restructure my code.',
    author: mockUsers[3],
    channelId: 'channel-2',
  ...
  {
    id: 'msg-9',
    content: 'Just finished my first web server in Rust using Axum! It was quite a journey but I love how fast it is.',
    author: mockUsers[4],
    channelId: 'channel-3',
  ...
  {
    id: 'msg-10',
    content: 'That\'s awesome! Axum is a great choice. Did you implement any middleware?',
    author: mockUsers[0],
    channelId: 'channel-3',
  ...
  {
    id: 'msg-13',
    content: '📢 **Important Announcement**: We\'re upgrading our servers this weekend. Expect some downtime on Saturday from 2-4 AM UTC.',
    author: {
      id: 'bot-1',
      username: 'FerriscordBot',
      email: 'bot@ferriscord.com',
    ...
    reactions: [
      { emoji: '👍', count: 12, users: ['user-1', 'user-2', 'user-3', 'user-4', 'user-5'] },
    ],
  },
];
...
export const mockServerMembers: Record<string, User[]> = {
  'server-1': [mockUsers[0], mockUsers[1], mockUsers[2], mockUsers[3], mockUsers[5]],
...
export const mockApi = {
  ...
  login: async (credentials: { email: string; password: string }) => {
    ...
    if (credentials.email === 'admin@ferriscord.com' && credentials.password === 'password') {
      return {
        user: currentUser,
...
export const mockWebSocketEvents = {
  ...
  userStatusChanged: (callback: (userId: string, status: User['status']) => void) => {
    const interval = setInterval(() => {
